      ...
      <div className="flex flex-wrap gap-2">
        {tabs.map((tab, index) => (
          <div
            ...
            className={`cursor-pointer relative inline-flex items-center pl-4 pr-10 py-2 bg-[var(--rp-c-bg-mute)] !border-t-4 ${color[tab.props.data.type]} rounded text-sm font-mono whitespace-nowrap transition-opacity ${
          ...
          >
            ...
            <button 
              onClick={(e) => {
                e.stopPropagation();
                copyToClipboard(tab.props.data.name);
              }} 
