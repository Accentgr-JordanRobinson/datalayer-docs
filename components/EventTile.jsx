  ...
  return (
    <div className="flex flex-wrap gap-2">
      {events.map((event, index) => (
        <div
          key={index}
          className="relative inline-flex items-center pl-4 pr-10 py-2 bg-[var(--rp-c-bg-mute)] !border-t-4 !border-[var(--rp-c-brand-dark)] rounded text-sm font-mono whitespace-nowrap"
        >
          {event}
          <button 
